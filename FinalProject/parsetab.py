...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','Final_Project.py',43),
  ('expression -> expression MINUS term','expression',3,'p_expression','Final_Project.py',44),
  ('expression -> term','expression',1,'p_expression','Final_Project.py',45),
  ('term -> term TIMES factor','term',3,'p_term','Final_Project.py',58),
  ('term -> term DIVIDE factor','term',3,'p_term','Final_Project.py',59),
  ('term -> factor','term',1,'p_term','Final_Project.py',60),
  ('factor -> NUMBER','factor',1,'p_factor','Final_Project.py',73),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','Final_Project.py',74),
]
